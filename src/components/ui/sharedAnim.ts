...
export const TITLE_CLS = "atom-title text-[1.5rem] font-semibold italic leading-[1.25] tracking-[-0.015em] text-[#1C1C1E] mb-4 relative z-10";
export const TITLE_STYLE = { fontFamily: "var(--font-literary)" } as const;
export const SUBTEXT_CLS = "atom-subtext font-sans text-[0.8125rem] font-light leading-[1.7] text-[#6B6B6F] relative z-10";
