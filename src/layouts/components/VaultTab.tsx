...
interface VaultTabProps {
  isActive: boolean;
  savedVaultCards: FeedCard[];
  setPhoneTab: (tab: any) => void;
...
export const VaultTab: React.FC<VaultTabProps> = ({
  ...
  return (
    <div id="vault-dashboard-emulation" className="w-full h-full sm:h-[85vh] sm:max-h-[850px] sm:min-h-[600px] sm:max-w-[420px] sm:rounded-[32px] sm:shadow-[0_20px_60px_rgba(0,0,0,0.15),0_8px_20px_rgba(0,0,0,0.1)] overflow-hidden relative bg-[#F5F3ED] flex flex-col justify-between"
