          ...
          return (
            ...
            >
              <div className={`w-9 h-9 rounded-lg flex items-center justify-center transition-all duration-300 relative ${
                ...
                {showBadge && (
                  <span className="absolute -top-1 -right-1 bg-[#B5A48B] text-white font-mono text-[8px] w-3.5 h-3.5 rounded-full flex items-center justify-center font-bold border border-[#FAF8F3]">
                    {savedVaultCardsCount}
                  </span>
                )}
              </div>
