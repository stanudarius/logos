...
export const PHILOSOPHER_BIOS: Record<string, PhilosopherBio> = {
  ...
  "Plato": {
    years: "c. 428–348 BC",
    position: "Rationalist founder of the Academy, established the theory of Forms.",
    keyWorks: ["The Republic", "Symposium", "Apology"]
  },
  "Aristotle": {
    years: "384–322 BC",
    position: "Empiricist who formalized logic and categorized human knowledge.",
    keyWorks: ["Nicomachean Ethics", "Politics", "Metaphysics"]
  },
  "Diogenes of Sinope": {
    years: "c. 412–323 BC",
    position: "Founder of Cynicism, famously lived in a barrel and rejected societal norms.",
    keyWorks: ["(No written works)"]
  },
  ...
  "Epictetus": {
    years: "c. 50–135 AD",
    position: "Stoic philosopher and former slave who emphasized self-discipline.",
  ...
  "Nietzsche": {
    years: "1844–1900",
    position: "Cultural critic who challenged conventional morality and championed the Übermensch.",
    keyWorks: ["Thus Spoke Zarathustra", "Beyond Good and Evil"]
  },
  "Sartre": {
    years: "1905–1980",
    position: "Key figure in existentialism, posited that 'existence precedes essence'.",
    keyWorks: ["Being and Nothingness", "No Exit"]
  },
  "Albert Camus": {
    years: "1913–1960",
    position: "Absurdist philosopher who explored the human search for meaning.",
  ...
  "Kant": {
    years: "1724–1804",
    position: "Synthesized rationalism and empiricism, formulated the categorical imperative.",
    keyWorks: ["Critique of Pure Reason", "Groundwork of the Metaphysics of Morals"]
  },
  "Jean Baudrillard": {
    years: "1929–2007",
    position: "Sociologist and philosopher known for his theories of simulacra and hyperreality.",
  ...
  "Shakespeare": {
    years: "1564–1616",
    position: "English playwright widely regarded as the greatest writer in the English language.",
  ...
  "Dostoevsky": {
    years: "1821–1881",
    position: "Russian novelist who explored human psychology in the context of political and social turmoil.",
    keyWorks: ["Crime and Punishment", "The Brothers Karamazov"]
  },
  "Kafka": {
    years: "1883–1924",
    position: "Bohemian novelist whose works explore themes of alienation and existential anxiety.",
    keyWorks: ["The Metamorphosis", "The Trial"]
  },
  "Virginia Woolf": {
    years: "1882–1941",
    position: "English writer and pioneer of the modernist stream-of-consciousness narrative.",
    keyWorks: ["Mrs Dalloway", "To the Lighthouse"]
  },
  "George Orwell": {
    years: "1903–1950",
    position: "English novelist and critic, known for his lucid prose and opposition to totalitarianism.",
    keyWorks: ["1984", "Animal Farm"]
  },
  "Marcel Proust": {
    years: "1871–1922",
    position: "French novelist whose work focuses on involuntary memory and the passage of time.",
  ...
  "Jorge Luis Borges": {
    years: "1899–1986",
    position: "Argentine short-story writer known for his labyrinthine philosophical fiction.",
  ...
  "Michelangelo": {
    years: "1475–1564",
    position: "Italian sculptor, painter, and architect of the High Renaissance.",
    keyWorks: ["David", "Sistine Chapel ceiling"]
  },
  "Rembrandt": {
    years: "1606–1669",
    position: "Dutch Golden Age painter and printmaker known for his mastery of light and shadow.",
