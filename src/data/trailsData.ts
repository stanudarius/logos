...
export const READING_TRAILS: ReadingTrail[] = [
  ...
  },
  {
    ...
    description:
      "Finding virtue between the extremes of excess and deficiency.",
  ...
  },
  {
    ...
    description:
      "Practical wisdom for navigating the treacherous waters of life.",
    thinkerIds: ["Seneca"],
  },
  {
  ...
  },
  {
    ...
    description:
      "Navigating dread and the individual's relation to the divine.",
